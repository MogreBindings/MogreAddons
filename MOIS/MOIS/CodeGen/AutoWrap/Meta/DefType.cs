...
{
    enum ProtectionType {Public, Private, Protected }

    abstract class DefType : AttributeHolder
    {
    ...
    class DefClass : DefType
    {
        ...
        public DefField GetField(string name, bool raiseException)
        {
            ...
            if (field == null && raiseException)
                throw new Exception("DefField not found");
        ...
        public DefMember GetMember(string name, bool raiseException)
        {
            ...
            if (raiseException)
                throw new Exception("DefMember not found");
            else
                return null;
        }
        ...
        public DefMember[] GetMembers(string name, bool raiseException)
        {
            ...
            if (list.Count == 0 && raiseException)
                throw new Exception("DefMembers not found");
