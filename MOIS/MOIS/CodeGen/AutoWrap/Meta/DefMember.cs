...
namespace AutoWrap.Meta
{
    ...
    abstract class DefMember : AttributeHolder, ITypeMember
    {
    ...
    enum VirtualType { Virtual, NonVirtual, PureVirtual }
    enum PassedByType { Value, Reference, Pointer, PointerPointer }

    class DefFunction : DefMember
    {
        ...
        public bool IsDeclarableFunction
        {
            get
            {
                if (_isDeclarableFunction == null)
                    _isDeclarableFunction = !(IsConstructor || IsListenerAdder || IsListenerRemover || IsListenerSetter
        ...
        public bool IsListenerSetter
        {
            get
            {
                return (HasAttribute<ListenerSetterAttribute>()
                        && Parameters.Count == 1
                        && Parameters[0].Type.HasWrapType(WrapTypes.NativeDirector));
            }
        }
    ...
    class DefParam : AttributeHolder, ITypeMember
    {
        string ITypeMember.TypeName
        {
            get { return this.TypeName; }
