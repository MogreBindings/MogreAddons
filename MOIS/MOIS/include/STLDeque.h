...
#define CPP_DECLARE_STLDEQUE_NONCONST( PREFIX, CLASS_NAME, M, N )							\
	...
	{																				\
		_native->assign(count, ToNative<M,N>( value ));								\
																					...
																					\
	M PREFIX##CLASS_NAME::Front::get() { return ToManaged<M,N>( _native->front() ); }		\
																					\
	M PREFIX##CLASS_NAME::Back::get() { return ToManaged<M,N>( _native->back() ); }	\
																					\
		...
		M PREFIX##Const_##CLASS_NAME::ConstIterator::Value::get()							\
			{																		\
				return ToManaged<M,N>( *(*_native) );								\
																					...
																					\
	M PREFIX##Const_##CLASS_NAME::Front::get() { return ToManaged<M,N>( _native->front() ); }	\
																					\
	M PREFIX##Const_##CLASS_NAME::Back::get() { return ToManaged<M,N>( _native->back() ); }	\
																					\
