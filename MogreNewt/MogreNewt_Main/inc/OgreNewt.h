/*
	...
	connects Mogre with the Newton Game Dynamics physics library

	by Argiris Kirtzidis
	some changes by gantz

	This is a C++/CLI port of the OgreNewt library by Walaber (http://walaber.com)

	main header file.

	current version:  2.0 (beta)

		Newton version: 2.10 (beta)
...
/*! \mainpage MogreNewt Library version 2.09(for newton version 2.09)
	...
	MogreNewt log
		Features to add
		- change dispose pattern use Dispose() ; event Disposed ; bool IsDisposed (done for World and Body)
		- get back some behavior of the old debugger regarding mass and contact change of color
		- logging in a separate thread, include log4net and have a separated log file for MogreNewt

		Bug to fix
		- fix some violation exception in treecollision class  : repro bug here : http://www.ogre3d.org/addonforums/viewtopic.php?f=8&t=10997
		...
		- m_World.SetThreadCount(2); produce a bug with bounding box updating of ogre object, see support multithreading in ogrenewt
		report : http://www.ogre3d.org/addonforums/viewtopic.php?f=8&t=11247&p=64439
